...
def arguments():
    ...
    parser.add_argument("-s", "--source", dest="source", type=str, metavar="<SOURCE_MAC>", help="Source MAC address")
    parser.add_argument("-n", "--network", dest="bssid", type=str, metavar="<BSSID>", help="BSSID of the target network")
    ...
    parser.add_argument("--flood", dest="flood", type=int, metavar="<TIME_IN_SECONDS>", help="Flood attack with time duration in seconds, cannot be used with --count")
    parser.add_argument("--count", dest="count", type=int, metavar="<INT>", help="Number of frames to send, cannot be used with --flood")

    parser.add_argument("--fragment-random", dest="fragment_random", action="store_true", help="Randomize fragment size")
    ...
    parser.add_argument("--duration", dest="duration", default=0, metavar="<TIME_IN_MS>", type=int, help="Duration of the attack in milliseconds")
